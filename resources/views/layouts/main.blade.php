        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item active">
                        @auth()
                            <a class="nav-link" href="{{ route('personal.main') }}">Personal Area<span class="sr-only">(current)</span></a>
                        @endauth
                        @guest()
                                <a class="nav-link" href="{{ route('personal.main') }}">Login<span class="sr-only">(current)</span></a>
                        @endguest
                    </li>
                </ul>
